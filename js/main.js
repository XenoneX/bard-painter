...
function BardPainter(options) {
    ...
    function paintInit(options) {
        ...
        param.painter = new BeginDraw();
        param.painter.startApp();
    }
...
//        startApp();
        ...
        function presetPoints() {
            if (!param.preloadPoints.length) return;

            var points = param.preloadPoints;
            ...
            if (id == param.canvasId) {
                ...
                if (param.mouseDownFlag) {
                    if (param.point.over && !param.complete) {
                        ...
                        param.painter.drawBackground(coords.dx, coords.dy);
                        param.painter.drawPlan();
                    }
                } else {
                    mouseOverSideMove(e);
        ...
        function mouseWheelHandler(e) {
            ...
            if (id == param.canvasId) {
                ...
                param.painter.drawBackground(dx, dy);
        ...
        */
        ...
        this.drawBackground = function (dx, dy) {
    ...
    //                    btn[btnList[i]].hide();
        ...
        function sideMove(coords) {
            ...
            var move = function() {
                param.painter.drawBackground(param.sideMove.dx, param.sideMove.dy);
    ...
    param.getPoints = this.getPoints;
    param.getNumberAngles = this.getNumberAngles;
    param.getPerimeter = this.getPerimeter;
    param.getSquare = this.getSquare;
};
